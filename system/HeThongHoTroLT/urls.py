...
urlpatterns = [
    ...
    path('detail_student/<str:student_id>', views.detail_student,name='detail_student'), 
    ...
    path('reload_results/<str:student_id>', views.reload_results, name='reload_results'),
